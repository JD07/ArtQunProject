...
tf.app.flags.DEFINE_string('training_data_path', '/home/jd/textimage/',
                           'training dataset to use')
tf.app.flags.DEFINE_integer('max_image_large_side', 1920,
...
def generator(input_size=512, batch_size=4,
